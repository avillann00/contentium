  ...
  return(
    <div className='w-screen min-h-screen bg-blue-50 flex flex-col'>
      <div className='bg-white text-black text-center gap-8 px-4 py-4'>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Contentium.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Contentium, accessible from <a href="https://contentium.vercel.app" rel="external nofollow noopener" target="_blank">https://contentium.vercel.app</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: avillann00@gmail.com</p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="https://contentium.vercel.app/" rel="external nofollow noopener" target="_blank">https://contentium.vercel.app/</a></p>
        </li>
        <li>
        <p>By phone number: 813.847.7312</p>
        </li>
        </ul>
        <button 
          onClick={() => router.push('/')}
